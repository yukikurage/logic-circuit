...
button content eventHandler = HH.div
  [ css """text-yukiRed bg-white border-yukiRed border-2 text-lg rounded-md p-2
    flex items-center justify-center cursor-pointer hover:bg-yukiRed
    hover:text-white duration-75"""
