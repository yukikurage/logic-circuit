...
(function($PS) {
  ...
  var monadApp = Halogen_Store_Monad.monadStoreT(Effect_Aff.monadAff);
  var applicativeApp = Halogen_Store_Monad.applicativeStoreT(Effect_Aff.applicativeAff);
  var contentHandlerApp = {
      save: Control_Applicative.pure(applicativeApp)(Data_Unit.unit),
      load: Control_Applicative.pure(applicativeApp)(Data_Unit.unit),
      Monad0: function () {
          return monadApp;
      }
  };
  var runApp = function (dictMonad) {
      return function (store) {
          var $10 = Halogen_Store_Monad.runStoreT(dictMonad)(store)(LogicWeb_Store.reduce);
          var $11 = Safe_Coerce.coerce();
          return function ($12) {
              return $10($11($12));
          };
      };
  ...
  exports["contentHandlerApp"] = contentHandlerApp;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["LogicWeb.Components.FormulaInput"] = $PS["LogicWeb.Components.FormulaInput"] || {};
  var exports = $PS["LogicWeb.Components.FormulaInput"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Either = $PS["Data.Either"];
  var Data_Maybe = $PS["Data.Maybe"];
                  ...
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(""))(function (v2) {
                      return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(false))(function (v3) {
                          return Halogen_Hooks_Hook.discard(Halogen_Hooks.useQuery(token.queryToken)(function (v4) {
                              ...
                              throw new Error("Failed pattern match at LogicWeb.Components.FormulaInput (line 29, column 35 - line 33, column 22): " + [ v4.constructor.name ]);
                          }))(function () {
                              return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("flex flex-row items-start w-full border-b-2 border-yukiRed relative") ])([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("text-lg px-2 py rounded-br-lg border-yukiRed " + (function () {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v2.value1)(s))(function () {
                                      var result = LogicWeb_PropositionalLogic_Formula_Parser.parse(LogicWeb_PropositionalLogic_Formula_Primitive.primEnv)(s);
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.raise(token.outputToken)(Changed.create(result)))(function () {
                                          return Halogen_Hooks_HookM.put(v1.value1)((function () {
                                              if (result instanceof Data_Either.Right) {
                                                  return "";
                                              };
                                              if (result instanceof Data_Either.Left && (result.value0 instanceof LogicWeb_PropositionalLogic_Formula_Parser.BadRequest && result.value0.value0 instanceof LogicWeb_PropositionalLogic_Formula_Parser.Inconsistencies)) {
                                                  return "\u5165\u529b\u306b\u4e0d\u6574\u5408\u304c\u3042\u308a\u307e\u3059";
                                              };
                                              if (result instanceof Data_Either.Left && result.value0 instanceof LogicWeb_PropositionalLogic_Formula_Parser.InternalError) {
                                                  return "\u5185\u90e8\u30a8\u30e9\u30fc: " + result.value0.value0;
                                              };
                                              if (result instanceof Data_Either.Left && (result.value0 instanceof LogicWeb_PropositionalLogic_Formula_Parser.BadRequest && result.value0.value0 instanceof LogicWeb_PropositionalLogic_Formula_Parser.DuplicatedToken)) {
                                                  return "\u5165\u529b\u306b\u4e0d\u6574\u5408\u304c\u3042\u308a\u307e\u3059: " + result.value0.value0.value0;
                                              };
                                              if (result instanceof Data_Either.Left && (result.value0 instanceof LogicWeb_PropositionalLogic_Formula_Parser.BadRequest && result.value0.value0 instanceof LogicWeb_PropositionalLogic_Formula_Parser.NoSuchToken)) {
                                                  return "\u30c8\u30fc\u30af\u30f3\u304c\u898b\u3064\u304b\u308a\u307e\u305b\u3093: " + result.value0.value0.value0;
                                              };
                                              if (result instanceof Data_Either.Left && (result.value0 instanceof LogicWeb_PropositionalLogic_Formula_Parser.BadRequest && result.value0.value0 instanceof LogicWeb_PropositionalLogic_Formula_Parser.EmptyRequest)) {
                                                  return "";
                                              };
                                              throw new Error("Failed pattern match at LogicWeb.Components.FormulaInput (line 49, column 36 - line 55, column 47): " + [ result.constructor.name ]);
                                          })());
                                      });
                                  });
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v3.value1)(true))(function () {
                                      return Halogen_Hooks_HookM.raise(token.outputToken)(Changed.create(LogicWeb_PropositionalLogic_Formula_Parser.parse(LogicWeb_PropositionalLogic_Formula_Primitive.primEnv)(v2.value0)));
                                  });
          ...
          return function (v) {
              ...
              var makeRow = function (xs) {
                  return Halogen_HTML_Elements.tr([ LogicWeb_Components_Common.css("font-sans h-10") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)((function () {
                      var $12 = Halogen_HTML_Elements.td([ LogicWeb_Components_Common.css("border-t px-3 border-yukiRed") ]);
                      return function ($13) {
                          return $12(Data_Array.singleton(Halogen_HTML_Core.text(showBoolean($13))));
                      };
              ...
              return Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("shadow-md bg-white relative z-30 p-5 rounded-md flex flex-col items-center text-lg") ])([ Halogen_HTML_Core.text("\u771f\u7406\u5024\u8868"), LogicWeb_Components_HTML_RootButton.button([ Halogen_HTML_Core.text("\u9023\u8a00\u6a19\u6e96\u5f62\u3092\u4f5c\u6210") ])(function (v1) {
                  return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)(dictMonad)(Data_Functor.map(((dictMonad.Bind1()).Apply0()).Functor0())(function (v2) {
                      ...
                      throw new Error("Failed pattern match at LogicWeb.Components.HTML.TruthTable (line 30, column 5 - line 32, column 27): " + [ v2.constructor.name ]);
                  });
                  ...
                  var $14 = Halogen_HTML_Elements.th([ LogicWeb_Components_Common.css("border-b-4 px-3 border-yukiRed") ]);
                  return function ($15) {
                      return $14(Data_Array.singleton(Halogen_HTML_Core.text($15)));
                  };
...
(function($PS) {
  ...
  var LogicWeb_Components_Common = $PS["LogicWeb.Components.Common"];
  var LogicWeb_Components_FormulaInput = $PS["LogicWeb.Components.FormulaInput"];
  var LogicWeb_Components_HTML_RootButton = $PS["LogicWeb.Components.HTML.RootButton"];
  ...
  var component = function (dictContentHandler) {
      return function (dictMonadStore) {
                          ...
                          return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState([  ]))(function (v2) {
                              return Halogen_Hooks_Hook.bind(Halogen_Store_UseSelector.useSelector(dictMonadStore)(Halogen_Store_Select.selectEq(Data_Eq.eqArray(Data_Eq.eqString))(function (v3) {
                                  ...
                                  var saveData = Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Data_Traversable["for"](Halogen_Hooks_HookM.applicativeHookM)(Data_Traversable.traversableArray)(v2.value0)(function (id) {
                                      ...
                                      })(Data_Ord.ordInt)(token.slotToken)(formulaInput_)(id)(LogicWeb_Components_FormulaInput.GetValue.create);
                                  }))(function (xs) {
                                      return Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)(dictContentHandler.Monad0())(Halogen_Store_Monad.updateStore(dictMonadStore)(LogicWeb_Store.SetFormulas.create(Data_Array.catMaybes(xs))));
                                  });
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v2.value1)(LogicWeb_Common.upRange(0)(Data_Array.length(xs) - 1 | 0)))(function () {
                                          return Data_FoldableWithIndex.forWithIndex_(Halogen_Hooks_HookM.applicativeHookM)(Data_FoldableWithIndex.foldableWithIndexArray)(xs)(function (i) {
                                              return function (str) {
                                                  ...
                                                  })(Data_Ord.ordInt)(token.slotToken)(formulaInput_)(i)(LogicWeb_Components_FormulaInput.SetValue.create(str));
                                              };
                                          });
                                      });
                                  });
                                  var handleChangedFormula = function (id) {
                                      return function (v3) {
                                          if (v3 instanceof LogicWeb_Components_FormulaInput.Changed) {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)((function () {
                                                  if (v3.value0 instanceof Data_Either.Right) {
                                                      return Halogen_Hooks_HookM.put(v1.value1)(LogicWeb_PropositionalLogic.toTruthTable(LogicWeb_PropositionalLogic.propositionalLogicFormula)(v3.value0.value0));
                                                  };
                                                  if (v3.value0 instanceof Data_Either.Left && (v3.value0.value0 instanceof LogicWeb_PropositionalLogic_Formula_Parser.BadRequest && v3.value0.value0.value0 instanceof LogicWeb_PropositionalLogic_Formula_Parser.EmptyRequest)) {
                                          ...
                                          if (v3 instanceof LogicWeb_Components_FormulaInput.Delete) {
                                          ...
                                          throw new Error("Failed pattern match at LogicWeb.Components.Pages.FormulaEditor (line 49, column 31 - line 58, column 17): " + [ v3.constructor.name ]);
                                      };
                                  };
                                  return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(loadData)(function () {
                                      ...
                                      return Halogen_Hooks_Hook.discard(Halogen_Hooks.captures(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()({
                                          ...
                                          return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("flex flex-row h-full relative") ])([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("flex flex-col flex-grow overflow-auto shadow-md relative z-30") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("h-12 w-16 m-6") ])([ LogicWeb_Components_HTML_RootButton.button([ Halogen_HTML_Elements.i([ LogicWeb_Components_Common.css("fas fa-plus") ])([  ]) ])(function (v3) {
                                              ...
                                              throw new Error("Failed pattern match at LogicWeb.Components.Pages.FormulaEditor (line 78, column 54 - line 82, column 53): " + [ v4.constructor.name ]);
                                          }) ]) ])(Data_Function.flip(Data_Array.mapWithIndex)(Debug.spy()("a")(v2.value0))(function (i) {
                                              return function (id) {
                                                  return Halogen_HTML.slot()({
                                                      reflectSymbol: function () {
                                                          return "formulaInput";
                                                      }
                                                  })(Data_Ord.ordInt)(formulaInput_)(id)(LogicWeb_Components_FormulaInput.component(dictMonadEffect))({
                                                      name: Data_Show.show(Data_Show.showInt)(i)
                                                  })(handleChangedFormula(id));
                                              };
                                          }))), Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("overflow-auto w-auto font-meiryo text-lg bg-yukiYellow flex-col flex items-center p-10") ])([ LogicWeb_Components_HTML_TruthTable.displayTruthTable(dictContentHandler.Monad0())(dictMonadStore)(v1.value0) ]) ]));
                                      });
                                  });
                              });
                          });
              ...
              return function (v1) {
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(v1.variables))(function (v2) {
                      return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(Data_Functor.map(Data_Functor.functorArray)(function (xs) {
                          ...
                          var makeRow = function (i) {
                              return function (xs) {
                                  return Halogen_HTML_Elements.tr([ LogicWeb_Components_Common.css("font-sans h-10") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)((function () {
                                      ...
                                      return Halogen_Hooks_HookM.put(v3.value1)(Data_Maybe.fromMaybe(v3.value0)(Data_Array.modifyAt(i)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(v3.value0)));
                                  }) ])([ divButton(Data_Maybe.fromMaybe(false)(Data_Array.index(v3.value0)(i))) ]) ]));
                              };
                          };
                          return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("bg-yukiYellow h-full p-3 flex flex-row") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("flex flex-col") ])([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("flex flex-col rounded-md bg-white shadow-md items-start") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("h-12 w-auto m-3") ])([ LogicWeb_Components_HTML_RootButton.button([ Halogen_HTML_Core.text("\u5909\u6570\u8ffd\u52a0") ])(function (v4) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v2.value1)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v2.value0)([ Data_Show.show(Data_Show.showInt)(Data_Array.length(v2.value0)) ])))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v3.value1)(Data_Array.concat(Data_Array.zipWith(function (x) {
                                      return function (y) {
                                          return [ x, y ];
                                      };
                                  })(v3.value0)(v3.value0))))(function () {
                                      return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Unit.unit);
                                  });
                              });
                              ...
                              return function (v4) {
                                  return Halogen_HTML_Elements.input([ LogicWeb_Components_Common.css("text-lg w-80 p-3 border-b-2 mb-3 border-yukiRed outline-none"), Halogen_HTML_Properties.value(v4), Halogen_HTML_Events.onValueInput(function (s) {
                                      return Halogen_Hooks_HookM.put(v2.value1)(Data_Maybe.fromMaybe(v2.value0)(Data_Array.updateAt(i)(s)(v2.value0)));
                                  }) ]);
                              };
                          })(v2.value0))) ]), Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("shadow-md bg-white relative z-30 p-5 rounded-md flex flex-col items-center ml-3") ])([ Halogen_HTML_Elements.table([ LogicWeb_Components_Common.css("table-fixed text-xl border-collapse whitespace-nowrap mt-3 tracking-wider") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.tr([ LogicWeb_Components_Common.css("font-math h-10") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)((function () {
                          ...
                          })())(v2.value0))([ Halogen_HTML_Elements.th([ LogicWeb_Components_Common.css("border-l-4 border-b-4 px-3 border-yukiRed") ])([  ]) ])) ])(Data_Array.mapWithIndex(makeRow)(Data_Unfoldable.replicateA(Control_Applicative.applicativeArray)(Data_Unfoldable.unfoldableArray)(Data_Traversable.traversableArray)(Data_Array.length(v2.value0))([ false, true ])))) ]) ])(Data_Maybe.fromMaybe([ Halogen_HTML_Core.text("\u5909\u6570\u540d\u304c\u91cd\u8907\u3057\u3066\u3044\u307e\u3059") ])(Data_Functor.map(Data_Maybe.functorMaybe)((function () {
                              var $28 = LogicWeb_Components_HTML_TruthTable.displayTruthTable(dictContentHandler.Monad0())(dictMonadStore);
                              return function ($29) {
                                  return Data_Array.singleton($28($29));
                              };
                          })())(makeTruthTable)))));
                      });
                  });
...
(function($PS) {
  ...
  var component = function (dictMonadEffect) {
      return function (dictMonadStore) {
          return function (dictContentHandler) {
              return Halogen_Hooks_Component.component(function (v) {
                  return function (v1) {
                      return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(LogicWeb_Type_Page.FormulaEditor.value))(function (v2) {
                          var makeMenu = function (iconFont) {
                              return function (p) {
                                  return Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("cursor-pointer text-3xl w-14 h-16 flex items-center justify-center " + (function () {
                                      var $9 = Data_Eq.eq(LogicWeb_Type_Page.eqPage)(p)(v2.value0);
                                      if ($9) {
                                          return "";
                                      };
                                      return "opacity-50";
                          ...
                          return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("h-auto flex flex-row text-yukiBlack") ])([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("min-h-screen w-16 bg-yukiBlack text-white flex flex-col items-center") ])([ makeMenu("fas fa-align-left")(LogicWeb_Type_Page.FormulaEditor.value), makeMenu("fas fa-table")(LogicWeb_Type_Page.TruthTableEditor.value) ]), Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("min-h-screen flex-grow") ])([ (function () {
                              ...
                              if (v2.value0 instanceof LogicWeb_Type_Page.TruthTableEditor) {
                                  ...
                                  })(Data_Ord.ordUnit)(truthTableEditor_)(Data_Unit.unit)(LogicWeb_Components_Pages_TruthTableEditor.component(dictContentHandler)(dictMonadStore))({
                                      variables: [ "\u03b1" ],
                                      output: "output",
                                      table: function (f) {
                                          var v3 = f("0");
                              ...
                              throw new Error("Failed pattern match at LogicWeb.Components.Body (line 48, column 9 - line 56, column 14): " + [ v2.value0.constructor.name ]);
                          })() ]) ]));
                      });
                  };
              });
...
(function($PS) {
  ...
  var main = Effect_Aff.launchAff_(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Effect_Aff.bindAff)(LogicWeb_App.runApp(Effect_Aff.monadAff)(LogicWeb_Store.initialStore)(LogicWeb_Components_Body.component(LogicWeb_App.monadEffectApp)(LogicWeb_App.monadStoreActionStoreApp)(LogicWeb_App.contentHandlerApp)))(function (body) {
