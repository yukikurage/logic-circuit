              ...
              return function (slotToken) {
                  return function (label) {
                      return function (slot) {
                          return function (req) {
                              return query()(dictIsSymbol)(dictOrd)(slotToken)(label)(slot)(Halogen_Query.mkRequest(req));
                          };
                      };
                  };
              };
...
(function($PS) {
                  ...
                  return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(dictMonadAff.MonadEffect0()))(function __do() {
                      ...
                      return filterEmitter(store.emitter)(function ($$new) {
                          return function __do() {
                              ...
                              var $21 = v.eq(prevDerived)(newDerived);
                              if ($21) {
                                  return Data_Maybe.Nothing.value;
                              };
  ...
  var monadStoreHookM = function (dictMonadStore) {
      return {
          getStore: Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)((dictMonadStore.MonadEffect0()).Monad0())(getStore(dictMonadStore)),
          updateStore: (function () {
              var $30 = Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)((dictMonadStore.MonadEffect0()).Monad0());
              var $31 = updateStore(dictMonadStore);
              return function ($32) {
                  return $30($31($32));
              };
          })(),
          emitSelected: (function () {
              var $33 = Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)((dictMonadStore.MonadEffect0()).Monad0());
              var $34 = emitSelected(dictMonadStore);
              return function ($35) {
                  return $33($34($35));
              };
          })(),
          MonadEffect0: function () {
              return Halogen_Hooks_HookM.monadEffectHookM(dictMonadStore.MonadEffect0());
          }
      };
  };
  ...
  exports["monadStoreHookM"] = monadStoreHookM;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Halogen.Store.UseSelector"] = $PS["Halogen.Store.UseSelector"] || {};
  var exports = $PS["Halogen.Store.UseSelector"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var Halogen_Subscription = $PS["Halogen.Subscription"];
  var useSelector = function (dictMonadStore) {
      return function (v) {
          var hook = Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(Data_Maybe.Nothing.value))(function (v1) {
              return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Store_Monad.emitSelected(Halogen_Store_Monad.monadStoreHookM(dictMonadStore))(v))(function (emitter) {
                  return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.subscribe(Data_Functor.map(Halogen_Subscription.functorEmitter)((function () {
                      var $8 = Halogen_Hooks_HookM.put(v1.value1);
                      return function ($9) {
                          return $8(Data_Maybe.Just.create($9));
                      };
                  })())(emitter)))(function (subscriptionId) {
                      return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Maybe.Just.create(Halogen_Hooks_HookM.unsubscribe(subscriptionId)));
                  });
              })))(function () {
                  return Halogen_Hooks_Hook.pure(v1.value0);
              });
          });
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["LogicWeb.Common"] = $PS["LogicWeb.Common"] || {};
  var exports = $PS["LogicWeb.Common"];
  var Data_Array = $PS["Data.Array"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_String_Common = $PS["Data.String.Common"];                
  var upRange = function (x) {
      return function (y) {
          var $3 = x > y;
          if ($3) {
              return [  ];
          };
          return Data_Array.range(x)(y);
      };
  };
  var splitCaseEmpty = function (p) {
      return function (v) {
          return Data_Maybe.fromMaybe([  ])(Data_Array.init(Data_String_Common.split(p)(v)));
      };
  };
  var showBool = function (v) {
      if (v) {
          return "1";
      };
      return "0";
  };
  var readBool = function (v) {
      if (v === "1") {
  ...
  exports["upRange"] = upRange;
  exports["showBool"] = showBool;
  exports["readBool"] = readBool;
  exports["splitCaseEmpty"] = splitCaseEmpty;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["LogicWeb.Type.RawTruthTable"] = $PS["LogicWeb.Type.RawTruthTable"] || {};
  var exports = $PS["LogicWeb.Type.RawTruthTable"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Array = $PS["Data.Array"];
  var Data_Functor = $PS["Data.Functor"];
  ...
  var fromTruthTable = function (v) {
      return Data_Functor.map(Data_Maybe.functorMaybe)(function (rs) {
          return {
              name: emptyRawTruthTable.name,
              variables: v.variables,
              results: rs
          };
      })(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(function (xs) {
          return v.table(function (v1) {
              return Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Array.index(xs))(Data_Array.findIndex(function (v2) {
                  return v2 === v1;
              })(v.variables));
          });
      })(Data_Unfoldable.replicateA(Control_Applicative.applicativeArray)(Data_Unfoldable.unfoldableArray)(Data_Traversable.traversableArray)(Data_Array.length(v.variables))([ false, true ])));
  };
  exports["toString"] = toString;
  exports["fromString"] = fromString;
  exports["emptyRawTruthTable"] = emptyRawTruthTable;
  exports["fromTruthTable"] = fromTruthTable;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var SetFormulas = (function () {
      function SetFormulas(value0) {
          this.value0 = value0;
      };
      SetFormulas.create = function (value0) {
          return new SetFormulas(value0);
      };
      return SetFormulas;
  })();
  var SetTruthTables = (function () {
      function SetTruthTables(value0) {
          this.value0 = value0;
      };
      SetTruthTables.create = function (value0) {
          return new SetTruthTables(value0);
      };
      return SetTruthTables;
  })();
  var save = function (dictMonadEffect) {
      return function (dictMonadStore) {
          return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Effect_Class.liftEffect(dictMonadEffect)(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.localStorage)(Web_HTML.window)))(function (s) {
              return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Data_Functor.map((((dictMonadEffect.Monad0()).Bind1()).Apply0()).Functor0())(function (v) {
                  return v.formulas;
              })(Halogen_Store_Monad.getStore(dictMonadStore)))(function (formulas) {
                  return Control_Bind.discard(Control_Bind.discardUnit)((dictMonadEffect.Monad0()).Bind1())(Effect_Class.liftEffect(dictMonadEffect)(Web_Storage_Storage.setItem("formulas")(Data_Array.fold(Data_Monoid.monoidString)(Data_Functor.map(Data_Functor.functorArray)(function (v) {
                      return v + ";";
                  })(formulas)))(s)))(function () {
                      return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Data_Functor.map((((dictMonadEffect.Monad0()).Bind1()).Apply0()).Functor0())(function (v) {
                          return v.truthTables;
                      })(Halogen_Store_Monad.getStore(dictMonadStore)))(function (truthTables) {
                          return Effect_Class.liftEffect(dictMonadEffect)(Web_Storage_Storage.setItem("truthTables")(Data_Array.fold(Data_Monoid.monoidString)(Data_Functor.map(Data_Functor.functorArray)(function (v) {
                              return v + ";";
                          })(Data_Functor.map(Data_Functor.functorArray)(LogicWeb_Type_RawTruthTable.toString)(truthTables))))(s));
                      });
                  });
              });
          });
  ...
  var reduce = function (store) {
      return function (v) {
          if (v instanceof SetFormulas) {
              return {
                  formulas: v.value0,
                  truthTables: store.truthTables
              };
          };
          if (v instanceof SetTruthTables) {
              return {
                  formulas: store.formulas,
                  truthTables: v.value0
              };
          };
          throw new Error("Failed pattern match at LogicWeb.Store (line 31, column 16 - line 33, column 46): " + [ v.constructor.name ]);
      };
  };
  var initialStore = {
      formulas: [ "(\xacP&P)=>Q" ],
          ...
          return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Effect_Class.liftEffect(dictMonadEffect)(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.localStorage)(Web_HTML.window)))(function (s) {
              return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Effect_Class.liftEffect(dictMonadEffect)(Web_Storage_Storage.getItem("formulas")(s)))(function (fs) {
                  return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Effect_Class.liftEffect(dictMonadEffect)(Web_Storage_Storage.getItem("truthTables")(s)))(function (ts) {
                      var truthTables = (function () {
                          if (ts instanceof Data_Maybe.Just) {
                              return Data_Maybe.fromMaybe([  ])(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(LogicWeb_Type_RawTruthTable.fromString)(LogicWeb_Common.splitCaseEmpty(";")(ts.value0)));
                          };
                          if (ts instanceof Data_Maybe.Nothing) {
                              return initialStore.truthTables;
                          };
                          throw new Error("Failed pattern match at LogicWeb.Store (line 54, column 19 - line 56, column 42): " + [ ts.constructor.name ]);
                      })();
                      var formulas = (function () {
                          if (fs instanceof Data_Maybe.Just) {
                              return LogicWeb_Common.splitCaseEmpty(";")(fs.value0);
                          };
                          if (fs instanceof Data_Maybe.Nothing) {
                              return initialStore.formulas;
                          };
                          throw new Error("Failed pattern match at LogicWeb.Store (line 51, column 16 - line 53, column 39): " + [ fs.constructor.name ]);
                      })();
  ...
  exports["SetTruthTables"] = SetTruthTables;
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["LogicWeb.App"] = $PS["LogicWeb.App"] || {};
  var exports = $PS["LogicWeb.App"];
  var Effect_Aff = $PS["Effect.Aff"];
  ...
  var monadEffectApp = Halogen_Store_Monad.monadEffectStoreT(Effect_Aff.monadEffectAff);
  var monadStoreActionStoreApp = {
      getStore: Halogen_Store_Monad.getStore(Halogen_Store_Monad.monadStoreStoreT(Effect_Aff_Class.monadAffAff)),
      updateStore: function (x) {
          return Cons(Halogen_Store_Monad.updateStore(Halogen_Store_Monad.monadStoreStoreT(Effect_Aff_Class.monadAffAff))(x));
      },
      emitSelected: function (x) {
          return Cons(Halogen_Store_Monad.emitSelected(Halogen_Store_Monad.monadStoreStoreT(Effect_Aff_Class.monadAffAff))(x));
      },
      MonadEffect0: function () {
          return monadEffectApp;
      }
  };                                                                                    
  var runApp = function (dictMonad) {
      return function (store) {
          var $9 = Halogen_Store_Monad.runStoreT(dictMonad)(store)(LogicWeb_Store.reduce);
  ...
  exports["monadStoreActionStoreApp"] = monadStoreActionStoreApp;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["LogicWeb.Components.Common"] = $PS["LogicWeb.Components.Common"] || {};
  var exports = $PS["LogicWeb.Components.Common"];
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["LogicWeb.Components.HTML.RootButton"] = $PS["LogicWeb.Components.HTML.RootButton"] || {};
  var exports = $PS["LogicWeb.Components.HTML.RootButton"];
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["LogicWeb.PropositionalLogic.Formula"] = $PS["LogicWeb.PropositionalLogic.Formula"] || {};
  var exports = $PS["LogicWeb.PropositionalLogic.Formula"];
  var Control_Apply = $PS["Control.Apply"];
  var Data_Array = $PS["Data.Array"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var MonadicOperate = (function () {
      function MonadicOperate(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      MonadicOperate.create = function (value0) {
          return function (value1) {
              return new MonadicOperate(value0, value1);
          };
      };
      return MonadicOperate;
  })();
  var BinaryOperate = (function () {
      function BinaryOperate(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      BinaryOperate.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new BinaryOperate(value0, value1, value2);
              };
          };
      };
      return BinaryOperate;
  })();
  var showFormula = {
      show: function (v) {
          if (v instanceof Var) {
          ...
          if (v instanceof MonadicOperate) {
              return "(" + (v.value0.symbol + (Data_Show.show(showFormula)(v.value1) + ")"));
          };
          if (v instanceof BinaryOperate) {
              return "(" + (Data_Show.show(showFormula)(v.value1) + (v.value0.symbol + (Data_Show.show(showFormula)(v.value2) + ")")));
          };
          throw new Error("Failed pattern match at LogicWeb.PropositionalLogic.Formula (line 54, column 1 - line 57, column 78): " + [ v.constructor.name ]);
      }
  };
  var eqAssociative = {
      eq: function (x) {
  ...
  var variables = function (v) {
      if (v instanceof Var) {
          return [ v.value0 ];
      };
      if (v instanceof MonadicOperate) {
          return Data_Array.nub(Data_Ord.ordString)(variables(v.value1));
      };
      if (v instanceof BinaryOperate) {
          return Data_Array.nub(Data_Ord.ordString)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(variables(v.value1))(variables(v.value2)));
      };
      throw new Error("Failed pattern match at LogicWeb.PropositionalLogic.Formula (line 37, column 1 - line 37, column 39): " + [ v.constructor.name ]);
  };
  var compute = function (v) {
      return function (vs) {
          ...
          if (v instanceof MonadicOperate) {
              return Data_Functor.map(Data_Maybe.functorMaybe)(v.value0.value)(compute(v.value1)(vs));
          };
          if (v instanceof BinaryOperate) {
              return Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(v.value0.value)(compute(v.value1)(vs)))(compute(v.value2)(vs));
          };
          throw new Error("Failed pattern match at LogicWeb.PropositionalLogic.Formula (line 49, column 1 - line 49, column 67): " + [ v.constructor.name, vs.constructor.name ]);
      };
  };
  exports["Left"] = Left;
  exports["Right"] = Right;
  exports["Var"] = Var;
  exports["MonadicOperate"] = MonadicOperate;
  exports["BinaryOperate"] = BinaryOperate;
  exports["variables"] = variables;
  exports["compute"] = compute;
  exports["eqAssociative"] = eqAssociative;
  exports["showFormula"] = showFormula;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["LogicWeb.PropositionalLogic.Formula.Primitive"] = $PS["LogicWeb.PropositionalLogic.Formula.Primitive"] || {};
  var exports = $PS["LogicWeb.PropositionalLogic.Formula.Primitive"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_HeytingAlgebra = $PS["Data.HeytingAlgebra"];
  var Data_Maybe = $PS["Data.Maybe"];
  var LogicWeb_PropositionalLogic_Formula = $PS["LogicWeb.PropositionalLogic.Formula"];                
  var primOr3 = {
      symbol: "|",
      value: Data_HeytingAlgebra.disj(Data_HeytingAlgebra.heytingAlgebraBoolean),
      priority: 60,
      associative: new Data_Maybe.Just(LogicWeb_PropositionalLogic_Formula.Left.value)
  };
  var primOr2 = {
      symbol: "+",
      value: Data_HeytingAlgebra.disj(Data_HeytingAlgebra.heytingAlgebraBoolean),
  ...
  var primNot2 = {
      symbol: "!",
      value: Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean),
      priority: 100,
      associative: new Data_Maybe.Just(LogicWeb_PropositionalLogic_Formula.Right.value)
  };
  var primNot = {
      symbol: "\xac",
      value: Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean),
  ...
  var primImplication2 = {
      symbol: "=>",
      value: Data_HeytingAlgebra.implies(Data_HeytingAlgebra.heytingAlgebraBoolean),
      priority: 40,
      associative: new Data_Maybe.Just(LogicWeb_PropositionalLogic_Formula.Right.value)
  };
  var primImplication = {
  ...
  var primEq4 = {
      symbol: "\u27fa",
      value: Data_Eq.eq(Data_Eq.eqBoolean),
      priority: 20,
      associative: new Data_Maybe.Just(LogicWeb_PropositionalLogic_Formula.Left.value)
  };
  var primEq2 = {
  ...
  var primAnd3 = {
      symbol: "&",
      value: Data_HeytingAlgebra.conj(Data_HeytingAlgebra.heytingAlgebraBoolean),
      priority: 80,
      associative: new Data_Maybe.Just(LogicWeb_PropositionalLogic_Formula.Left.value)
  };
  var primAnd2 = {
  ...
  exports["primNot"] = primNot;
  exports["primAnd"] = primAnd;
  exports["primOr"] = primOr;
  exports["primEnv"] = primEnv;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["LogicWeb.PropositionalLogic"] = $PS["LogicWeb.PropositionalLogic"] || {};
  var exports = $PS["LogicWeb.PropositionalLogic"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Category = $PS["Control.Category"];
  ...
  var propositionalLogicTruthTa = {
      toTruthTable: Control_Category.identity(Control_Category.categoryFn)
  };
  var propositionalLogicFormula = {
      toTruthTable: function (f) {
          var vs = LogicWeb_PropositionalLogic_Formula.variables(f);
          return {
              variables: vs,
              output: Data_Show.show(LogicWeb_PropositionalLogic_Formula.showFormula)(f),
              table: LogicWeb_PropositionalLogic_Formula.compute(f)
          };
      }
  };
  var toTruthTable = function (dict) {
      return dict.toTruthTable;
  };
  var dnf = function (dictPropositionalLogic) {
      return function (a) {
          var v = toTruthTable(dictPropositionalLogic)(a);
          var xs = Data_Array.filter(function (vs) {
              return Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqBoolean))(v.table(function (v1) {
                  return Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Array.index(vs))(Data_Array.findIndex(function (v2) {
                      return v2 === v1;
                  })(v.variables));
              }))(new Data_Maybe.Just(true));
          })(Data_Unfoldable.replicateA(Control_Applicative.applicativeArray)(Data_Unfoldable.unfoldableArray)(Data_Traversable.traversableArray)(Data_Array.length(v.variables))([ false, true ]));
          var literal = function (i) {
              return function (f) {
                  var v1 = Data_Functor.map(Data_Maybe.functorMaybe)(LogicWeb_PropositionalLogic_Formula.Var.create)(Data_Array.index(v.variables)(i));
                  if (f) {
                      return v1;
                  };
                  return Data_Functor.map(Data_Maybe.functorMaybe)(LogicWeb_PropositionalLogic_Formula.MonadicOperate.create(LogicWeb_PropositionalLogic_Formula_Primitive.primNot))(v1);
              };
          };
          var term = function (xs1) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.uncons(xs1))(function (v1) {
                  return Data_FoldableWithIndex.foldlWithIndex(Data_FoldableWithIndex.foldableWithIndexArray)(function (i) {
                      return function (mf) {
                          return function (x) {
                              return Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(LogicWeb_PropositionalLogic_Formula.BinaryOperate.create(LogicWeb_PropositionalLogic_Formula_Primitive.primAnd))(mf))(literal(i + 1 | 0)(x));
                          };
                      };
                  })(literal(0)(v1.head))(v1.tail);
              });
          };
          var res = function (xs1) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.uncons(xs1))(function (v1) {
                  return Data_Array.foldl(function (mf) {
                      return function (x) {
                          return Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(LogicWeb_PropositionalLogic_Formula.BinaryOperate.create(LogicWeb_PropositionalLogic_Formula_Primitive.primOr))(mf))(term(x));
                      };
                  })(term(v1.head))(v1.tail);
              });
          };
          return res(xs);
      };
  };
  var cnf = function (dictPropositionalLogic) {
      return function (a) {
          var v = toTruthTable(dictPropositionalLogic)(a);
          var xs = Data_Array.filter(function (vs) {
              return Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqBoolean))(v.table(function (v1) {
          ...
          var term = function (xs1) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.uncons(xs1))(function (v1) {
                  return Data_FoldableWithIndex.foldlWithIndex(Data_FoldableWithIndex.foldableWithIndexArray)(function (i) {
                      return function (mf) {
                          return function (x) {
                              return Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(LogicWeb_PropositionalLogic_Formula.BinaryOperate.create(LogicWeb_PropositionalLogic_Formula_Primitive.primOr))(mf))(literal(i + 1 | 0)(x));
                          };
                      };
                  })(literal(0)(v1.head))(v1.tail);
              });
          ...
          var res = function (xs1) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.uncons(xs1))(function (v1) {
                  return Data_Array.foldl(function (mf) {
                      return function (x) {
                          return Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(LogicWeb_PropositionalLogic_Formula.BinaryOperate.create(LogicWeb_PropositionalLogic_Formula_Primitive.primAnd))(mf))(term(x));
                      };
                  })(term(v1.head))(v1.tail);
              });
          };
  ...
  exports["toTruthTable"] = toTruthTable;
  exports["cnf"] = cnf;
  exports["dnf"] = dnf;
  exports["propositionalLogicTruthTa"] = propositionalLogicTruthTa;
  exports["propositionalLogicFormula"] = propositionalLogicFormula;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["LogicWeb.PropositionalLogic.TruthTable"] = $PS["LogicWeb.PropositionalLogic.TruthTable"] || {};
  var exports = $PS["LogicWeb.PropositionalLogic.TruthTable"];
  var Data_Array = $PS["Data.Array"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Function = $PS["Data.Function"];
  var Data_Maybe = $PS["Data.Maybe"];
  var $$null = function (v) {
      return Data_Array["null"](v.variables) && Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqBoolean))(v.table(Data_Function["const"](Data_Maybe.Nothing.value)))(Data_Maybe.Nothing.value);
  };
  var emptyTruthTable = {
      variables: [  ],
      output: "",
      table: Data_Function["const"](Data_Maybe.Nothing.value)
  };
  exports["emptyTruthTable"] = emptyTruthTable;
  exports["null"] = $$null;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["LogicWeb.Components.HTML.TruthTable"] = $PS["LogicWeb.Components.HTML.TruthTable"] || {};
  var exports = $PS["LogicWeb.Components.HTML.TruthTable"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Trans_Class = $PS["Control.Monad.Trans.Class"];
  var Data_Array = $PS["Data.Array"];
  ...
  var LogicWeb_Store = $PS["LogicWeb.Store"];
  var LogicWeb_Type_RawTruthTable = $PS["LogicWeb.Type.RawTruthTable"];                
  var displayTruthTable = function (dictMonad) {
      return function (dictMonadStore) {
          return function (v) {
              if (LogicWeb_PropositionalLogic_TruthTable["null"](v)) {
                  return Halogen_HTML_Elements.table_([  ]);
              };
              var showBoolean = function (v1) {
                  if (v1) {
                      return "1";
                  };
                  return "0";
              };
              var showMaybeBoolean = Data_Maybe.maybe("*")(showBoolean);
              var makeRow = function (xs) {
                  return Halogen_HTML_Elements.tr([ LogicWeb_Components_Common.css("font-sans h-10") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)((function () {
                      var $22 = Halogen_HTML_Elements.td([ LogicWeb_Components_Common.css("border-t px-3 border-yukiRed") ]);
                      return function ($23) {
                          return $22(Data_Array.singleton(Halogen_HTML_Core.text(showBoolean($23))));
                      };
                  })())(xs))([ Halogen_HTML_Elements.td([ LogicWeb_Components_Common.css("border-l-4 border-t px-3 border-yukiRed") ])([ Halogen_HTML_Core.text(showMaybeBoolean(v.table(function (v1) {
                      return Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Array.index(xs))(Data_Array.findIndex(function (v2) {
                          return v2 === v1;
                      })(v.variables));
                  }))) ]) ]));
              };
              return Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("shadow-md bg-white relative z-30 p-3 rounded-md flex flex-col items-center text-lg") ])([ Halogen_HTML_Core.text("\u771f\u7406\u5024\u8868"), Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("mt-3") ])([ LogicWeb_Components_HTML_RootButton.button([ Halogen_HTML_Core.text("\u9023\u8a00\u6a19\u6e96\u5f62\u3092\u4f5c\u6210") ])(function (v1) {
                  return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)(dictMonad)(Data_Functor.map(((dictMonad.Bind1()).Apply0()).Functor0())(function (v2) {
                      return v2.formulas;
                  })(Halogen_Store_Monad.getStore(dictMonadStore))))(function (fs) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)((function () {
                          var v2 = LogicWeb_PropositionalLogic.cnf(LogicWeb_PropositionalLogic.propositionalLogicTruthTa)(v);
                          if (v2 instanceof Data_Maybe.Just) {
                              return Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)(dictMonad)(Halogen_Store_Monad.updateStore(dictMonadStore)(LogicWeb_Store.SetFormulas.create(Data_Array.snoc(fs)(Data_Show.show(LogicWeb_PropositionalLogic_Formula.showFormula)(v2.value0)))));
                          };
                          if (v2 instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Unit.unit);
                          };
                          throw new Error("Failed pattern match at LogicWeb.Components.HTML.TruthTable (line 32, column 7 - line 34, column 29): " + [ v2.constructor.name ]);
                      })())(function () {
              ...
              }) ]), Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("mt-3") ])([ LogicWeb_Components_HTML_RootButton.button([ Halogen_HTML_Core.text("\u9078\u8a00\u6a19\u6e96\u5f62\u3092\u4f5c\u6210") ])(function (v1) {
                  return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)(dictMonad)(Data_Functor.map(((dictMonad.Bind1()).Apply0()).Functor0())(function (v2) {
                      return v2.formulas;
                  })(Halogen_Store_Monad.getStore(dictMonadStore))))(function (fs) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)((function () {
                          var v2 = LogicWeb_PropositionalLogic.dnf(LogicWeb_PropositionalLogic.propositionalLogicTruthTa)(v);
                          if (v2 instanceof Data_Maybe.Just) {
                              return Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)(dictMonad)(Halogen_Store_Monad.updateStore(dictMonadStore)(LogicWeb_Store.SetFormulas.create(Data_Array.snoc(fs)(Data_Show.show(LogicWeb_PropositionalLogic_Formula.showFormula)(v2.value0)))));
                          };
                          if (v2 instanceof Data_Maybe.Nothing) {
                          ...
                          throw new Error("Failed pattern match at LogicWeb.Components.HTML.TruthTable (line 40, column 7 - line 42, column 29): " + [ v2.constructor.name ]);
                      })())(function () {
                          return LogicWeb_Store.save(Halogen_Hooks_HookM.monadEffectHookM(dictMonadStore.MonadEffect0()))(Halogen_Store_Monad.monadStoreHookM(dictMonadStore));
                      });
                  });
              }) ]), Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("mt-3") ])([ LogicWeb_Components_HTML_RootButton.button([ Halogen_HTML_Core.text("\u771f\u7406\u5024\u8868\u3068\u3057\u3066\u8ffd\u52a0") ])(function (v1) {
                  return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)(dictMonad)(Data_Functor.map(((dictMonad.Bind1()).Apply0()).Functor0())(function (v2) {
                      return v2.truthTables;
                  })(Halogen_Store_Monad.getStore(dictMonadStore))))(function (ts) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)((function () {
                          var v2 = LogicWeb_Type_RawTruthTable.fromTruthTable(v);
                          if (v2 instanceof Data_Maybe.Just) {
                              return Control_Monad_Trans_Class.lift(Halogen_Hooks_HookM.monadTransHookM)(dictMonad)(Halogen_Store_Monad.updateStore(dictMonadStore)(LogicWeb_Store.SetTruthTables.create(Data_Array.snoc(ts)(v2.value0))));
                          };
                          if (v2 instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Unit.unit);
                          };
                          throw new Error("Failed pattern match at LogicWeb.Components.HTML.TruthTable (line 48, column 7 - line 50, column 29): " + [ v2.constructor.name ]);
                      })())(function () {
                          return LogicWeb_Store.save(Halogen_Hooks_HookM.monadEffectHookM(dictMonadStore.MonadEffect0()))(Halogen_Store_Monad.monadStoreHookM(dictMonadStore));
                      });
                  });
              }) ]), Halogen_HTML_Elements.table([ LogicWeb_Components_Common.css("table-fixed text-xl border-collapse whitespace-nowrap mt-3 tracking-wider") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.tr([ LogicWeb_Components_Common.css("font-math h-10") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)((function () {
                  var $24 = Halogen_HTML_Elements.th([ LogicWeb_Components_Common.css("border-b-4 px-3 border-yukiRed") ]);
                  return function ($25) {
                      return $24(Data_Array.singleton(Halogen_HTML_Core.text($25)));
                  };
              })())(v.variables))([ Halogen_HTML_Elements.th([ LogicWeb_Components_Common.css("border-l-4 border-b-4 px-3 border-yukiRed") ])([  ]) ])) ])(Data_Functor.map(Data_Functor.functorArray)(makeRow)(Data_Unfoldable.replicateA(Control_Applicative.applicativeArray)(Data_Unfoldable.unfoldableArray)(Data_Traversable.traversableArray)(Data_Array.length(v.variables))([ false, true ])))) ]);
          };
      };
  };
  exports["displayTruthTable"] = displayTruthTable;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["LogicWeb.Components.Input"] = $PS["LogicWeb.Components.Input"] || {};
  var exports = $PS["LogicWeb.Components.Input"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
              ...
              return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(""))(function (v1) {
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(""))(function (v2) {
                      return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v1.value1)(v.messageHandler(v2.value0)))(function () {
                          ...
                          return Halogen_Hooks_Hook.discard(Halogen_Hooks.useQuery(token.queryToken)(function (v3) {
                              if (v3 instanceof GetValue) {
                                  return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Maybe.Just.create(v3.value0(v2.value0)));
                              };
                              if (v3 instanceof SetValue) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v2.value1)(v3.value0))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v1.value1)(v.messageHandler(v3.value0)))(function () {
                                          return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Maybe.Just.create(v3.value1));
                                      });
                                  });
                              };
                              throw new Error("Failed pattern match at LogicWeb.Components.Input (line 33, column 35 - line 38, column 22): " + [ v3.constructor.name ]);
                          }))(function () {
                              return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("flex flex-row items-start w-full border-b-2 border-yukiRed relative") ])([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("duration-75 text-lg px-2 py rounded-br-lg border-yukiRed " + (function () {
                                  if (v.focusing) {
                              ...
                              }), Halogen_HTML_Events.onFocusIn(function (v3) {
                              ...
                              }) ]), Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("absolute right-0 top-0 bg-transparent rounded-bl-lg border-yukiRed b text-yukiRed hover:bg-yukiRed hover:text-white text-xl cursor-pointer px-2"), Halogen_HTML_Events.onClick(function (v3) {
...
(function($PS) {
  ...
  var Focusing = (function () {
      function Focusing(value0) {
          this.value0 = value0;
      };
      Focusing.create = function (value0) {
          return new Focusing(value0);
      };
      return Focusing;
  })();
  var Changed = (function () {
  ...
  var component = function (dictMonadEffect) {
      return Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState([  ]))(function (v2) {
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(Data_Maybe.Nothing.value))(function (v3) {
                      var handleChangedInput = function (i) {
                          return function (v4) {
                              if (v4 instanceof LogicWeb_Components_Input.Changed) {
                                  return Halogen_Hooks_HookM.raise(v.outputToken)(new Changed(i, v4.value0));
                              };
                              if (v4 instanceof LogicWeb_Components_Input.Delete) {
                                  var newInputs = Data_Maybe.fromMaybe(v2.value0)(Data_Array.deleteAt(i)(v2.value0));
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v2.value1)(newInputs))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.raise(v.outputToken)(new Delete(i)))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v3.value1)(Data_Maybe.Nothing.value))(function () {
                                              return Halogen_Hooks_HookM.raise(v.outputToken)(new Focus(Data_Maybe.Nothing.value));
                                          });
                                      });
                                  });
                              };
                              if (v4 instanceof LogicWeb_Components_Input.Focus) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v3.value1)(new Data_Maybe.Just(i)))(function () {
                                      return Halogen_Hooks_HookM.raise(v.outputToken)(Focus.create(new Data_Maybe.Just(i)));
                                  });
                              };
                              throw new Error("Failed pattern match at LogicWeb.Components.InputsList (line 37, column 28 - line 52, column 49): " + [ v4.constructor.name ]);
                          };
                      };
                      var handleAddButton = function (v4) {
                          var newInputs = (function () {
                              var v5 = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(function (m) {
                              ...
                              if (v5 instanceof Data_Maybe.Just) {
                                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)(v2.value0)([ v5.value0 ]);
                              };
                              if (v5 instanceof Data_Maybe.Nothing) {
                                  return [ 0 ];
                              };
                              throw new Error("Failed pattern match at LogicWeb.Components.InputsList (line 56, column 21 - line 58, column 25): " + [ v5.constructor.name ]);
                          })();
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v2.value1)(newInputs))(function () {
                              return Halogen_Hooks_HookM.raise(v.outputToken)(Add.value);
                          });
                      };
                      var getValues = function (xs) {
                          return Data_Functor.map(Halogen_Hooks_HookM.functorHookM)((function () {
                              var $30 = Data_Maybe.fromMaybe([  ]);
                              var $31 = Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe);
                              return function ($32) {
                                  return $30($31($32));
                              };
                          })())(Data_Traversable["for"](Halogen_Hooks_HookM.applicativeHookM)(Data_Traversable.traversableArray)(xs)(function (id) {
                      ...
                      return Halogen_Hooks_Hook.discard(Halogen_Hooks.useQuery(v.queryToken)(function (v4) {
                          if (v4 instanceof GetValues) {
                              return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(getValues(v2.value0))(function (res) {
                                  return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Maybe.Just.create(v4.value0(res)));
                              });
                          };
                          if (v4 instanceof SetValues) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v2.value1)(LogicWeb_Common.upRange(0)(Data_Array.length(v4.value0) - 1 | 0)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Data_FoldableWithIndex.forWithIndex_(Halogen_Hooks_HookM.applicativeHookM)(Data_FoldableWithIndex.foldableWithIndexArray)(v4.value0)(function (i) {
                                      return function (str) {
                                      ...
                                      return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(new Data_Maybe.Just(v4.value1));
                                  });
                              });
                          };
                          if (v4 instanceof Focusing) {
                              return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Functor.map(Data_Maybe.functorMaybe)(v4.value0)(v3.value0));
                          };
                          throw new Error("Failed pattern match at LogicWeb.Components.InputsList (line 62, column 29 - line 71, column 32): " + [ v4.constructor.name ]);
                      }))(function () {
                          return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("flex flex-col overflow-auto relative") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Function.flip(Data_Array.mapWithIndex)(v2.value0)(function (i) {
                              return function (id) {
                                  return Halogen_HTML.slot()({
                                      ...
                                      focusing: Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(v3.value0)(new Data_Maybe.Just(i))
                                  })(handleChangedInput(i));
                              };
                          }))([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("h-12 w-16 m-3") ])([ LogicWeb_Components_HTML_RootButton.button([ Halogen_HTML_Elements.i([ LogicWeb_Components_Common.css("fas fa-plus") ])([  ]) ])(handleAddButton) ]) ])));
                      });
                  });
              });
          };
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["LogicWeb.PropositionalLogic.Formula.Parser"] = $PS["LogicWeb.PropositionalLogic.Formula.Parser"] || {};
  var exports = $PS["LogicWeb.PropositionalLogic.Formula.Parser"];
  ...
  var MonadicOperator = (function () {
      function MonadicOperator(value0) {
          this.value0 = value0;
      };
      MonadicOperator.create = function (value0) {
          return new MonadicOperator(value0);
      };
      return MonadicOperator;
  })();
  ...
  var LeftBracket = (function () {
      ...
      LeftBracket.value = new LeftBracket();
      return LeftBracket;
  })();
  var RightBracket = (function () {
      ...
      RightBracket.value = new RightBracket();
      return RightBracket;
  })();
  var NoSuchToken = (function () {
      function NoSuchToken(value0) {
          this.value0 = value0;
      };
      NoSuchToken.create = function (value0) {
          return new NoSuchToken(value0);
      };
      return NoSuchToken;
  })();
  var DuplicatedToken = (function () {
      function DuplicatedToken(value0) {
          this.value0 = value0;
      };
      DuplicatedToken.create = function (value0) {
          return new DuplicatedToken(value0);
      };
  ...
  var Inconsistencies = (function () {
      ...
      Inconsistencies.value = new Inconsistencies();
  ...
  var EmptyRequest = (function () {
      ...
      EmptyRequest.value = new EmptyRequest();
      return EmptyRequest;
  })();
  ...
  var shuntingYard = function (symbols) {
      var loop = function ($copy_remaining) {
          return function ($copy_output) {
              return function ($copy_stack) {
                  ...
                  var $tco_var_output = $copy_output;
                  var $tco_done = false;
                  var $tco_result;
                  function $tco_loop(remaining, output, stack) {
                      var v = Data_Array.uncons(remaining);
                      if (v instanceof Data_Maybe.Just) {
                          var caseOperator = function (sym) {
                              return function (o1) {
                                  var notFrag = function (v1) {
                                      if (v1 instanceof MonadicOperator) {
                                          return o1.priority > v1.value0.priority || Data_Eq.notEq(Data_Maybe.eqMaybe(LogicWeb_PropositionalLogic_Formula.eqAssociative))(o1.associative)(new Data_Maybe.Just(LogicWeb_PropositionalLogic_Formula.Left.value)) && o1.priority >= v1.value0.priority;
                                      };
                                      if (v1 instanceof BinaryOperator) {
                                          return o1.priority > v1.value0.priority || Data_Eq.notEq(Data_Maybe.eqMaybe(LogicWeb_PropositionalLogic_Formula.eqAssociative))(o1.associative)(new Data_Maybe.Just(LogicWeb_PropositionalLogic_Formula.Left.value)) && o1.priority >= v1.value0.priority;
                                      };
                                      return true;
                                  };
                                  var extract = Data_Array.span((function () {
                                      var $44 = Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean);
                                      return function ($45) {
                                          return $44(notFrag($45));
                                      };
                                  })())(stack);
                                  $tco_var_remaining = v.value0.tail;
                                  $tco_var_output = Data_Semigroup.append(Data_Semigroup.semigroupArray)(output)(extract.init);
                                  $copy_stack = Data_Array.cons(sym)(extract.rest);
                                  return;
                              };
                          };
                          if (v.value0.head instanceof MonadicOperator) {
                              return caseOperator(v.value0.head)(v.value0.head.value0);
                          };
                          if (v.value0.head instanceof BinaryOperator) {
                              return caseOperator(v.value0.head)(v.value0.head.value0);
                          };
                          if (v.value0.head instanceof LeftBracket) {
                              $tco_var_remaining = v.value0.tail;
                              $tco_var_output = output;
                              $copy_stack = Data_Array.cons(LeftBracket.value)(stack);
                              return;
                          };
                          if (v.value0.head instanceof RightBracket) {
                              var frag = function (v1) {
                                  if (v1 instanceof LeftBracket) {
                                      return false;
                                  };
                                  return true;
                              };
                              var extract = Data_Array.span(frag)(stack);
                              $tco_var_remaining = v.value0.tail;
                              $tco_var_output = Data_Semigroup.append(Data_Semigroup.semigroupArray)(output)(extract.init);
                              $copy_stack = Data_Maybe.fromMaybe([  ])(Data_Array.tail(extract.rest));
                              return;
                          };
                          if (v.value0.head instanceof Variable) {
                              $tco_var_remaining = v.value0.tail;
                              $tco_var_output = Data_Array.snoc(output)(new Variable(v.value0.head.value0));
                              $copy_stack = stack;
                              return;
                          };
                          throw new Error("Failed pattern match at LogicWeb.PropositionalLogic.Formula.Parser (line 85, column 19 - line 97, column 69): " + [ v.value0.head.constructor.name ]);
                      };
                      if (v instanceof Data_Maybe.Nothing) {
                          $tco_done = true;
                          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(output)(stack);
                      };
                      throw new Error("Failed pattern match at LogicWeb.PropositionalLogic.Formula.Parser (line 84, column 33 - line 114, column 31): " + [ v.constructor.name ]);
                  };
                  while (!$tco_done) {
                      $tco_result = $tco_loop($tco_var_remaining, $tco_var_output, $copy_stack);
                  };
                  return $tco_result;
              };
          };
  ...
  var isAlphabet = function (x) {
      return Data_Array.elem(Data_String_CodePoints.eqCodePoint)(x)(Data_Functor.map(Data_Functor.functorArray)(Data_String_CodePoints.codePointFromChar)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Enum.enumFromTo(Data_Enum.enumChar)(Data_Unfoldable1.unfoldable1Array)("a")("z"))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Enum.enumFromTo(Data_Enum.enumChar)(Data_Unfoldable1.unfoldable1Array)("A")("Z"))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Enum.enumFromTo(Data_Enum.enumChar)(Data_Unfoldable1.unfoldable1Array)("\u03b1")("\u03c9"))(Data_Enum.enumFromTo(Data_Enum.enumChar)(Data_Unfoldable1.unfoldable1Array)("0")("9"))))));
  };
  var symbol = function (env) {
      return function (str) {
          return Data_Either.note(new BadRequest(new NoSuchToken(str)))((function () {
              var $29 = env.brackets.left === str;
              if ($29) {
                  return new Data_Maybe.Just(LeftBracket.value);
              };
              return Control_Alt.alt(Data_Maybe.altMaybe)(Data_Maybe.Nothing.value)((function () {
                  var $30 = env.brackets.right === str;
                  if ($30) {
                      return new Data_Maybe.Just(RightBracket.value);
                  };
                  return Control_Alt.alt(Data_Maybe.altMaybe)(Control_Alt.alt(Data_Maybe.altMaybe)(Control_Alt.alt(Data_Maybe.altMaybe)(Data_Maybe.Nothing.value)(Data_Functor.map(Data_Maybe.functorMaybe)(MonadicOperator.create)(Data_Array.find(function (x) {
                      return x.symbol === str;
                  })(env.monadicOperators))))(Data_Functor.map(Data_Maybe.functorMaybe)(BinaryOperator.create)(Data_Array.find(function (x) {
                      return x.symbol === str;
                  })(env.binaryOperators))))((function () {
                      var $31 = Data_Array.all(isAlphabet)(Data_String_CodePoints.toCodePointArray(str)) && Data_String_CodePoints.length(str) >= 1;
                      if ($31) {
                          return new Data_Maybe.Just(new Variable(str));
                      };
                      return Data_Maybe.Nothing.value;
                  })());
              })());
  ...
  var interpretation = function (s) {
      if (Data_Array["null"](s)) {
          return Data_Either.Left.create(new BadRequest(EmptyRequest.value));
      };
      var loop = function (remaining) {
          return function (stack) {
              var v = Data_Array.uncons(remaining);
              if (v instanceof Data_Maybe.Just) {
                  if (v.value0.head instanceof MonadicOperator) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note(new BadRequest(Inconsistencies.value))(Data_Array.uncons(stack)))(function (st) {
                          return loop(v.value0.tail)(Data_Array.cons(new LogicWeb_PropositionalLogic_Formula.MonadicOperate(v.value0.head.value0, st.head))(st.tail));
                      });
                  };
                  if (v.value0.head instanceof BinaryOperator) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note(new BadRequest(Inconsistencies.value))(Data_Array.uncons(stack)))(function (stack0) {
                          return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note(new BadRequest(Inconsistencies.value))(Data_Array.uncons(stack0.tail)))(function (stack1) {
                              return loop(v.value0.tail)(Data_Array.cons(new LogicWeb_PropositionalLogic_Formula.BinaryOperate(v.value0.head.value0, stack1.head, stack0.head))(stack1.tail));
                          });
                      });
                  };
                  if (v.value0.head instanceof Variable) {
                      return loop(v.value0.tail)(Data_Array.cons(new LogicWeb_PropositionalLogic_Formula.Var(v.value0.head.value0))(stack));
                  };
                  return Data_Either.Left.create(new BadRequest(Inconsistencies.value));
              };
              if (v instanceof Data_Maybe.Nothing) {
                  return Data_Either.note(new BadRequest(Inconsistencies.value))((function () {
                      var $39 = Data_Array.length(stack) === 1;
                      if ($39) {
                          return Data_Array.head(stack);
                      };
                      return Data_Maybe.Nothing.value;
                  })());
              };
              throw new Error("Failed pattern match at LogicWeb.PropositionalLogic.Formula.Parser (line 66, column 26 - line 79, column 58): " + [ v.constructor.name ]);
          };
      };
      return loop(s)([  ]);
  };
  var findUniquePrefix = function (env) {
      return function (str) {
          var f = function (i) {
              var s = Data_String_CodePoints.splitAt(i)(str);
              return Data_Functor.map(Data_Maybe.functorMaybe)(function (v) {
                  return {
                      prefix: v,
                      after: s.after
                  };
              })(Data_Either.hush(symbol(env)(s.before)));
          };
          var filtered = Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)(f)(Data_Array.range(0)(Data_String_CodePoints.length(str))));
          var result = (function () {
              var v = Data_Array.length(filtered);
              if (v === 0) {
                  return Data_Either.Left.create(BadRequest.create(new NoSuchToken(str)));
              };
              if (v === 1) {
                  return Data_Either.note(new InternalError("findUniquePrefix"))(Data_Array.head(filtered));
              };
              return Data_Either.Left.create(BadRequest.create(new DuplicatedToken(str)));
          })();
          return result;
      };
  };
  var split = function (env) {
      var loop = function (str) {
          var v = Data_Array.head(Data_String_CodePoints.toCodePointArray(str));
          if (v instanceof Data_Maybe.Just && isAlphabet(v.value0)) {
              var res = Data_Array.span(isAlphabet)(Data_String_CodePoints.toCodePointArray(str));
              var next = Data_String_CodePoints.fromCodePointArray(res.rest);
              var current = Variable.create(Data_String_CodePoints.fromCodePointArray(res.init));
              return Data_Functor.map(Data_Either.functorEither)(Data_Array.cons(current))(loop(next));
          };
          if (v instanceof Data_Maybe.Just) {
              var res = Data_Array.span(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraBoolean))(isAlphabet))(Data_String_CodePoints.toCodePointArray(str));
              var uniquePrefix = findUniquePrefix(env)(Data_String_CodePoints.fromCodePointArray(res.init));
              var next = Data_Functor.map(Data_Either.functorEither)(function (v1) {
                  return v1 + Data_String_CodePoints.fromCodePointArray(res.rest);
              })(Data_Functor.map(Data_Either.functorEither)(function (x) {
                  return x.after;
              })(uniquePrefix));
              var current = Data_Functor.map(Data_Either.functorEither)(function (v1) {
                  return v1.prefix;
              })(uniquePrefix);
              return Control_Apply.apply(Data_Either.applyEither)(Data_Functor.map(Data_Either.functorEither)(Data_Array.cons)(current))(Control_Bind.bindFlipped(Data_Either.bindEither)(loop)(next));
          };
          return new Data_Either.Right([  ]);
      };
      var $46 = Data_Functor.map(Data_Either.functorEither)(Data_Array.concat);
      var $47 = Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Either.applicativeEither);
      var $48 = Data_Functor.map(Data_Functor.functorArray)(loop);
      var $49 = Data_String_Common.split(" ");
      return function ($50) {
  ...
  var parse = function (env) {
      return function (str) {
          return Control_Bind.bindFlipped(Data_Either.bindEither)(function ($51) {
              return interpretation(shuntingYard($51));
          })(split(env)(str));
      };
  };
  exports["parse"] = parse;
  ...
  exports["NoSuchToken"] = NoSuchToken;
  exports["DuplicatedToken"] = DuplicatedToken;
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["LogicWeb.Components.Pages.FormulaEditor"] = $PS["LogicWeb.Components.Pages.FormulaEditor"] || {};
  var exports = $PS["LogicWeb.Components.Pages.FormulaEditor"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Trans_Class = $PS["Control.Monad.Trans.Class"];
  var Data_Array = $PS["Data.Array"];
                  ...
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(LogicWeb_PropositionalLogic_TruthTable.emptyTruthTable))(function (v1) {
                      return Halogen_Hooks_Hook.bind(Halogen_Store_UseSelector.useSelector(dictMonadStore)(Halogen_Store_Select.selectEq(Data_Eq.eqArray(Data_Eq.eqString))(function (v2) {
                          ...
                          var messageHandler = function (s) {
                              ...
                              throw new Error("Failed pattern match at LogicWeb.Components.Pages.FormulaEditor (line 39, column 24 - line 45, column 43): " + [ v2.constructor.name ]);
                          };
                          ...
                          var handleChangedInputs = function (v2) {
                              return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.request()({
                                  reflectSymbol: function () {
                                      return "inputsList_";
                                  }
                              })(Data_Ord.ordUnit)(token.slotToken)(inputsList_)(Data_Unit.unit)(LogicWeb_Components_InputsList.GetValues.create))(function (xs) {
                                  ...
                                  })(Data_Ord.ordUnit)(token.slotToken)(inputsList_)(Data_Unit.unit)(LogicWeb_Components_InputsList.Focusing.create))(function (i) {
                                      var s = Data_Maybe.fromMaybe("")(Control_Bind.bind(Data_Maybe.bindMaybe)(xs)(function (xs$prime) {
                                          return Control_Bind.bind(Data_Maybe.bindMaybe)(i)(function (i$prime) {
                                              return Data_Array.index(xs$prime)(i$prime);
                                          });
                                      }));
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)((function () {
                          ...
                          return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(LogicWeb_Store.load(Halogen_Hooks_HookM.monadEffectHookM(dictMonadEffect))(Halogen_Store_Monad.monadStoreHookM(dictMonadStore)))(function () {
                              ...
                              return Halogen_Hooks_Hook.discard(Halogen_Hooks.captures(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()({
                                  ...
                                  return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("flex flex-row h-full relative animate-fade-in-quick") ])([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("duration-75 flex-grow h-full bg-white shadow-md relative") ])([ Halogen_HTML.slot()({
                                      reflectSymbol: function () {
                                          return "inputsList_";
                                      }
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["LogicWeb.Components.Pages.SymbolsEditor"] = $PS["LogicWeb.Components.Pages.SymbolsEditor"] || {};
  var exports = $PS["LogicWeb.Components.Pages.SymbolsEditor"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Semigroup = $PS["Data.Semigroup"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  ...
  var LogicWeb_PropositionalLogic_Formula = $PS["LogicWeb.PropositionalLogic.Formula"];
  var LogicWeb_PropositionalLogic_Formula_Primitive = $PS["LogicWeb.PropositionalLogic.Formula.Primitive"];                
  var symbolPanel = function (x) {
      return Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("h-auto w-auto m-3") ])([ x ]);
  };
  var monadicOperatorPanel = function (dictMonad) {
      return function (dictMonadStore) {
          return function (op) {
              return symbolPanel(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("text-center") ])([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("font-math text-3xl w-full h-auto") ])([ Halogen_HTML_Core.text(op.symbol + "P") ]), LogicWeb_Components_HTML_TruthTable.displayTruthTable(dictMonad)(dictMonadStore)(LogicWeb_PropositionalLogic.toTruthTable(LogicWeb_PropositionalLogic.propositionalLogicFormula)(LogicWeb_PropositionalLogic_Formula.MonadicOperate.create(op)(new LogicWeb_PropositionalLogic_Formula.Var("P")))) ]));
          };
      };
  };
  var binaryOperatorPanel = function (dictMonad) {
      return function (dictMonadStore) {
          return function (op) {
              return symbolPanel(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("text-center") ])([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("font-math text-3xl w-full h-auto") ])([ Halogen_HTML_Core.text("P" + (op.symbol + "Q")) ]), LogicWeb_Components_HTML_TruthTable.displayTruthTable(dictMonad)(dictMonadStore)(LogicWeb_PropositionalLogic.toTruthTable(LogicWeb_PropositionalLogic.propositionalLogicFormula)(LogicWeb_PropositionalLogic_Formula.BinaryOperate.create(op)(new LogicWeb_PropositionalLogic_Formula.Var("P"))(new LogicWeb_PropositionalLogic_Formula.Var("Q")))) ]));
          };
      };
  };
  var component = function (dictMonad) {
      return function (dictMonadStore) {
          return Halogen_Hooks_Component.component(function (v) {
              return function (v1) {
                  return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("max-w-full items-start flex flex-row flex-wrap") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.mapFlipped(Data_Functor.functorArray)(LogicWeb_PropositionalLogic_Formula_Primitive.primEnv.binaryOperators)(binaryOperatorPanel(dictMonad)(dictMonadStore)))(Data_Functor.mapFlipped(Data_Functor.functorArray)(LogicWeb_PropositionalLogic_Formula_Primitive.primEnv.monadicOperators)(monadicOperatorPanel(dictMonad)(dictMonadStore)))));
              };
          });
      };
  };
                  ...
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(inputRawTruthTable.results))(function (v2) {
                      return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.tell()({
                          ...
                          var makeRow = function (i) {
                              return function (xs) {
                                  return Halogen_HTML_Elements.tr([ LogicWeb_Components_Common.css("font-sans h-10") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)((function () {
                                      var $26 = Halogen_HTML_Elements.td([ LogicWeb_Components_Common.css("border-t px-3 border-yukiRed") ]);
                                      return function ($27) {
                                          return $26(Data_Array.singleton(Halogen_HTML_Core.text(LogicWeb_Common.showBool($27))));
                                      };
                                      ...
                                      var newResults = Data_Maybe.fromMaybe(v2.value0)(Data_Array.modifyAt(i)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(v2.value0));
                          ...
                          var isValidVariables = function (v3) {
                              var v4 = LogicWeb_PropositionalLogic_Formula_Parser.parse(LogicWeb_PropositionalLogic_Formula_Primitive.primEnv)(v3);
                              if (v4 instanceof Data_Either.Right && v4.value0 instanceof LogicWeb_PropositionalLogic_Formula.Var) {
                                  return true;
                              };
                              return false;
                          };
                          var makeTruthTable = (function () {
                              if (Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(Data_Array.nub(Data_Ord.ordString)(v1.value0))(v1.value0) && (Data_Array.notElem(Data_Eq.eqString)("")(v1.value0) && Data_Array.all(isValidVariables)(v1.value0))) {
                                  return Data_Maybe.Just.create({
                                      ...
                                      table: function (f) {
                                          return Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Array.index(v2.value0))(Data_Functor.map(Data_Maybe.functorMaybe)((function () {
                                              var $28 = Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt);
                                              var $29 = Data_Array.mapWithIndex(function (i) {
                                                  return function (x) {
                          ...
                          var messageHandler = function (v3) {
                              ...
                              if (!isValidVariables(v3)) {
                                  return "\u4e0d\u6b63\u306a\u5024\u3067\u3059";
                              };
                              return "";
                          };
                          var handleChangeInputs = function (v3) {
                              return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Data_Functor.map(Halogen_Hooks_HookM.functorHookM)(Data_Maybe.fromMaybe([  ]))(Halogen_Hooks_HookM.request()({
                                  ...
                                  var newResults = (function () {
                                      var $19 = Data_Array.length(res) === Data_Array.length(v1.value0);
                                      if ($19) {
                                          return v2.value0;
                                      };
                                      return Data_Array.replicate(Data_Int.pow(2)(Data_Array.length(res)))(false);
                                  })();
                          ...
                          return Halogen_Hooks_Hook.discard(Halogen_Hooks.captures(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()({
                              ...
                              return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(LogicWeb_Store.load(Halogen_Hooks_HookM.monadEffectHookM(dictMonadStore.MonadEffect0()))(Halogen_Store_Monad.monadStoreHookM(dictMonadStore)))(function () {
                                  ...
                                  var handleTableEditOutput = function (o) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Store_Monad.updateStore(Halogen_Store_Monad.monadStoreHookM(dictMonadStore))(LogicWeb_Store.SetTruthTables.create(Data_Maybe.fromMaybe(v2.value0)(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(function (i) {
                                          return Data_Array.updateAt(i)(o.value0)(v2.value0);
                                      })(v3.value0)))))(function () {
                                          return LogicWeb_Store.save(Halogen_Hooks_HookM.monadEffectHookM(dictMonadStore.MonadEffect0()))(Halogen_Store_Monad.monadStoreHookM(dictMonadStore));
                                      });
                                  };
                                  var handleInputsOutput = function (o) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)((function () {
                                          if (o instanceof LogicWeb_Components_InputsList.Add) {
                                              return Halogen_Store_Monad.updateStore(Halogen_Store_Monad.monadStoreHookM(dictMonadStore))(LogicWeb_Store.SetTruthTables.create(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v2.value0)([ LogicWeb_Type_RawTruthTable.emptyRawTruthTable ])));
                                          };
                                          ...
                                          throw new Error("Failed pattern match at LogicWeb.Components.Pages.TruthTableEditor (line 56, column 7 - line 60, column 140): " + [ o.constructor.name ]);
                                      })())(function () {
                                          return LogicWeb_Store.save(Halogen_Hooks_HookM.monadEffectHookM(dictMonadStore.MonadEffect0()))(Halogen_Store_Monad.monadStoreHookM(dictMonadStore));
                                      });
                                  };
                                  return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("h-full flex flex-row relative animate-fade-in-quick") ])([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("h-full bg-white shadow-md relative w-[480px]") ])([ Halogen_HTML.slot()({
                                      ...
                                      var v4 = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Array.index(v2.value0))(v3.value0);
                                      if (v4 instanceof Data_Maybe.Just) {
                                          return [ Halogen_HTML.slot()({
                                              reflectSymbol: function () {
                                                  return "truthTableEditPanel";
                                              }
                                          })(Data_Maybe.ordMaybe(Data_Ord.ordInt))(truthTableEditPanel_)(v3.value0)(LogicWeb_Components_TruthTableEditPanel.component(dictMonadStore))(v4.value0)(handleTableEditOutput) ];
                                      };
                                      if (v4 instanceof Data_Maybe.Nothing) {
                                          return [  ];
                                      };
                                      throw new Error("Failed pattern match at LogicWeb.Components.Pages.TruthTableEditor (line 73, column 34 - line 75, column 22): " + [ v4.constructor.name ]);
                                  })()) ]));
                              });
                          });
                      });
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["LogicWeb.Type.Page"] = $PS["LogicWeb.Type.Page"] || {};
  var exports = $PS["LogicWeb.Type.Page"];
  var TruthTableEditor = (function () {
      function TruthTableEditor() {

      };
      TruthTableEditor.value = new TruthTableEditor();
  ...
  var SymbolsEditor = (function () {
      function SymbolsEditor() {

      };
      SymbolsEditor.value = new SymbolsEditor();
      return SymbolsEditor;
  })();
  var eqPage = {
      eq: function (x) {
          return function (y) {
              if (x instanceof TruthTableEditor && y instanceof TruthTableEditor) {
                  return true;
              };
              if (x instanceof FormulaEditor && y instanceof FormulaEditor) {
                  return true;
              };
              if (x instanceof SymbolsEditor && y instanceof SymbolsEditor) {
                  return true;
              };
              return false;
          };
  ...
  exports["TruthTableEditor"] = TruthTableEditor;
  exports["FormulaEditor"] = FormulaEditor;
  exports["SymbolsEditor"] = SymbolsEditor;
...
(function($PS) {
  ...
  var Halogen_Hooks_HookM = $PS["Halogen.Hooks.HookM"];
  var LogicWeb_Components_Common = $PS["LogicWeb.Components.Common"];
  var LogicWeb_Components_Pages_FormulaEditor = $PS["LogicWeb.Components.Pages.FormulaEditor"];
  var LogicWeb_Components_Pages_SymbolsEditor = $PS["LogicWeb.Components.Pages.SymbolsEditor"];
  var LogicWeb_Components_Pages_TruthTableEditor = $PS["LogicWeb.Components.Pages.TruthTableEditor"];
  var LogicWeb_Type_Page = $PS["LogicWeb.Type.Page"];
  var Type_Proxy = $PS["Type.Proxy"];                
  var truthTableEditor_ = Type_Proxy["Proxy"].value;
  var symbolsEditor_ = Type_Proxy["Proxy"].value;
  var formulaEditor_ = Type_Proxy["Proxy"].value;
  var component = function (dictMonadEffect) {
      return function (dictMonadStore) {
          return Halogen_Hooks_Component.component(function (v) {
              return function (v1) {
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(LogicWeb_Type_Page.FormulaEditor.value))(function (v2) {
                      var makeMenu = function (iconFont) {
                          return function (p) {
                              return Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("hover:opacity-70 cursor-pointer text-3xl w-14 h-16 flex items-center justify-center " + (function () {
                                  var $7 = Data_Eq.eq(LogicWeb_Type_Page.eqPage)(p)(v2.value0);
                                  if ($7) {
                                      return "hover:opacity-100";
                                  };
                                  return "opacity-50";
                              })()), Halogen_HTML_Events.onClick(function (v3) {
                                  return Halogen_Hooks_HookM.put(v2.value1)(p);
                      ...
                      return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("h-auto flex flex-row text-yukiBlack") ])([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("min-h-screen w-16 bg-yukiBlack text-white flex flex-col items-center relative") ])([ makeMenu("fas fa-align-left")(LogicWeb_Type_Page.FormulaEditor.value), makeMenu("fas fa-table")(LogicWeb_Type_Page.TruthTableEditor.value), makeMenu("fas fa-arrows-alt-h")(LogicWeb_Type_Page.SymbolsEditor.value), Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("font-math absolute bottom-11 transform -rotate-90 text-lg cursor-pointer") ])([ Halogen_HTML_Core.text("Yukiworks"), Halogen_HTML_Elements.a([ LogicWeb_Components_Common.css("absolute bottom-0 top-0 right-0 left-0"), Halogen_HTML_Properties.href(" https://yukikurage.github.io/portfolio/") ])([  ]) ]) ]), Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("min-h-screen h-auto w-full flex-col flex-grow flex") ])([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("h-auto bg-yukiRed text-white p-2 font-meiryo") ])([ Halogen_HTML_Core.text((function () {
                          ...
                          if (v2.value0 instanceof LogicWeb_Type_Page.TruthTableEditor) {
                              return "\u771f\u7406\u5024\u8868\u30a8\u30c7\u30a3\u30bf";
                          };
                          ...
                          if (v2.value0 instanceof LogicWeb_Type_Page.FormulaEditor) {
                              ...
                              })(Data_Ord.ordUnit)(formulaEditor_)(Data_Unit.unit)(LogicWeb_Components_Pages_FormulaEditor.component(dictMonadStore)(dictMonadEffect))(Data_Unit.unit);
                          };
                          if (v2.value0 instanceof LogicWeb_Type_Page.TruthTableEditor) {
                              return Halogen_HTML.slot_()({
                                  reflectSymbol: function () {
...
(function($PS) {
  ...
  var LogicWeb_App = $PS["LogicWeb.App"];
  var LogicWeb_Components_Body = $PS["LogicWeb.Components.Body"];
  var LogicWeb_Store = $PS["LogicWeb.Store"];                
  var main = Effect_Aff.launchAff_(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Effect_Aff.bindAff)(LogicWeb_App.runApp(Effect_Aff.monadAff)(LogicWeb_Store.initialStore)(LogicWeb_Components_Body.component(LogicWeb_App.monadEffectApp)(LogicWeb_App.monadStoreActionStoreApp)))(function (body) {
