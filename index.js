...
(function($PS) {
  ...
  var component = Halogen_Hooks_Component.component(function (token) {
      return function (initName) {
          return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(""))(function (v) {
              return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(""))(function (v1) {
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(false))(function (v2) {
                      ...
                      })()) ])([ Halogen_HTML_Core.text(initName) ]), Halogen_HTML_Elements.input([ LogicWeb_Components_Common.css("font-math text-3xl flex-grow p-4 tracking-widest outline-none w-full"), Halogen_HTML_Properties.value(v.value0), Halogen_HTML_Events.onValueInput(function (s) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v.value1)(s))(function () {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.raise(token.outputToken)(Changed.create(result)))(function () {
                                  return Halogen_Hooks_HookM.put(v1.value1)((function () {
                                      ...
                                      throw new Error("Failed pattern match at LogicWeb.Components.FormulaInput (line 39, column 36 - line 45, column 47): " + [ result.constructor.name ]);
                                  })());
                              });
                          });
                      }), Halogen_HTML_Events.onFocusIn(function (v3) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v2.value1)(true))(function () {
                              return Halogen_Hooks_HookM.raise(token.outputToken)(Changed.create(LogicWeb_PropositionalLogic_Formula_Parser.parse(LogicWeb_PropositionalLogic_Formula_Primitive.primEnv)(v.value0)));
                          });
                      }), Halogen_HTML_Events.onFocusOut(function (v3) {
                          return Halogen_Hooks_HookM.put(v2.value1)(false);
...
(function($PS) {
  ...
  var Data_Maybe = $PS["Data.Maybe"];                
  var $$null = function (t) {
      return Data_Array["null"](t.variables) && Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqBoolean))(t.table(Data_Function["const"](Data_Maybe.Nothing.value)))(Data_Maybe.Nothing.value);
  };
  var emptyTruthTable = {
      variables: [  ],
      output: "",
...
(function($PS) {
  ...
  var displayTruthTable = function (t) {
      if (LogicWeb_PropositionalLogic_TruthTable["null"](t)) {
          return Halogen_HTML_Elements.table_([  ]);
      };
      var showBoolean = function (v) {
          if (v) {
              return "1";
          };
          return "0";
      ...
      var makeRow = function (xs) {
          return Halogen_HTML_Elements.tr([ LogicWeb_Components_Common.css("font-sans h-10") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)((function () {
              var $4 = Halogen_HTML_Elements.td([ LogicWeb_Components_Common.css("border-t px-3 border-yukiRed") ]);
              return function ($5) {
                  return $4(Data_Array.singleton(Halogen_HTML_Core.text(showBoolean($5))));
              };
          })())(xs))([ Halogen_HTML_Elements.td([ LogicWeb_Components_Common.css("border-l-4 border-t px-3 border-yukiRed") ])([ Halogen_HTML_Core.text(showMaybeBoolean(t.table(function (v) {
              return Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Array.index(xs))(Data_Array.findIndex(function (v1) {
                  return v1 === v;
              })(t.variables));
          }))) ]) ]));
      };
      return Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("shadow-md bg-white relative z-30 p-5 rounded-md flex flex-col items-center text-lg") ])([ Halogen_HTML_Core.text("\u771f\u7406\u5024\u8868"), Halogen_HTML_Elements.table([ LogicWeb_Components_Common.css("table-fixed text-xl border-collapse whitespace-nowrap mt-3 tracking-wider") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.tr([ LogicWeb_Components_Common.css("font-math h-10") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)((function () {
          var $6 = Halogen_HTML_Elements.th([ LogicWeb_Components_Common.css("border-b-4 px-3 border-yukiRed") ]);
          return function ($7) {
              return $6(Data_Array.singleton(Halogen_HTML_Core.text($7)));
          };
      })())(t.variables))([ Halogen_HTML_Elements.th([ LogicWeb_Components_Common.css("border-l-4 border-b-4 px-3 border-yukiRed") ])([  ]) ])) ])(Data_Functor.map(Data_Functor.functorArray)(makeRow)(Data_Unfoldable.replicateA(Control_Applicative.applicativeArray)(Data_Unfoldable.unfoldableArray)(Data_Traversable.traversableArray)(Data_Array.length(t.variables))([ false, true ])))) ]);
  };
...
(function($PS) {
  ...
  var component = Halogen_Hooks_Component.component(function (v) {
      return function (v1) {
          return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(LogicWeb_PropositionalLogic_TruthTable.emptyTruthTable))(function (v2) {
              return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState([ 0 ]))(function (v3) {
                  var handleChangedFormula = function (id) {
                      return function (v4) {
                          if (v4 instanceof LogicWeb_Components_FormulaInput.Changed) {
                              if (v4.value0 instanceof Data_Either.Right) {
                                  return Halogen_Hooks_HookM.put(v2.value1)(LogicWeb_PropositionalLogic.toTruthTable(LogicWeb_PropositionalLogic.propositionalLogicFormula)(v4.value0.value0));
                              };
                              if (v4.value0 instanceof Data_Either.Left && (v4.value0.value0 instanceof LogicWeb_PropositionalLogic_Formula_Parser.BadRequest && v4.value0.value0.value0 instanceof LogicWeb_PropositionalLogic_Formula_Parser.EmptyRequest)) {
                                  return Halogen_Hooks_HookM.put(v2.value1)(LogicWeb_PropositionalLogic_TruthTable.emptyTruthTable);
                              };
                              return Halogen_Hooks_HookM.put(v2.value1)(LogicWeb_PropositionalLogic_TruthTable.emptyTruthTable);
                          };
                          if (v4 instanceof LogicWeb_Components_FormulaInput.Delete) {
                              return Halogen_Hooks_HookM.put(v3.value1)(Data_Array["delete"](Data_Eq.eqInt)(id)(v3.value0));
                          };
                          throw new Error("Failed pattern match at LogicWeb.Components.Pages.FormulaEditor (line 32, column 31 - line 37, column 58): " + [ v4.constructor.name ]);
                      };
                  };
                  return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("flex flex-row h-full relative") ])([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("flex flex-col flex-grow overflow-auto shadow-md relative z-30") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("h-12 w-16 m-6") ])([ LogicWeb_Components_HTML_RootButton.button([ Halogen_HTML_Elements.i([ LogicWeb_Components_Common.css("fas fa-plus") ])([  ]) ])(function (v4) {
                      var v5 = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(function (m) {
                          return Data_Array.find(Data_Function.flip(Data_Array.notElem(Data_Eq.eqInt))(v3.value0))(Data_Array.range(0)(m + 1 | 0));
                      })(Data_Foldable.maximum(Data_Ord.ordInt)(Data_Foldable.foldableArray)(v3.value0));
                      if (v5 instanceof Data_Maybe.Just) {
                          return Halogen_Hooks_HookM.put(v3.value1)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v3.value0)([ v5.value0 ]));
                      };
                      if (v5 instanceof Data_Maybe.Nothing) {
                          return Halogen_Hooks_HookM.put(v3.value1)([ 0 ]);
                      };
                      throw new Error("Failed pattern match at LogicWeb.Components.Pages.FormulaEditor (line 42, column 54 - line 44, column 50): " + [ v5.constructor.name ]);
                  }) ]) ])(Data_Function.flip(Data_Array.mapWithIndex)(v3.value0)(function (i) {
                      return function (id) {
                          return Halogen_HTML.slot()({
                              reflectSymbol: function () {
                                  return "formulaInput";
                              }
                          })(Data_Ord.ordInt)(formulaInput_)(id)(LogicWeb_Components_FormulaInput.component)(Data_Show.show(Data_Show.showInt)(i))(handleChangedFormula(id));
                      };
                  }))), Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("overflow-auto w-auto font-meiryo text-lg bg-yukiYellow flex-col flex items-center p-10") ])([ LogicWeb_Components_HTML_TruthTable.displayTruthTable(v2.value0) ]) ]));
              });
          });
      };
  });
...
(function($PS) {
  ...
  var component = Halogen_Hooks_Component.component(function (v) {
      return function (input) {
          return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(input.variables))(function (v1) {
              return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(Data_Functor.map(Data_Functor.functorArray)(function (xs) {
                  return Data_Maybe.fromMaybe(false)(input.table(function (v2) {
                      return Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Array.index(xs))(Data_Array.findIndex(function (v3) {
                          return v3 === v2;
                      })(input.variables));
                  }));
              })(Data_Unfoldable.replicateA(Control_Applicative.applicativeArray)(Data_Unfoldable.unfoldableArray)(Data_Traversable.traversableArray)(Data_Array.length(input.variables))([ false, true ]))))(function (v2) {
                  var showBoolean = function (v3) {
                      if (v3) {
                          return "1";
                      };
                      return "0";
                  ...
                  var makeTruthTable = (function () {
                      if (Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(Data_Array.nub(Data_Ord.ordString)(v1.value0))(v1.value0)) {
                          return new Data_Maybe.Just({
                              variables: v1.value0,
                              output: "",
                              table: function (f) {
                                  return Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Array.index(v2.value0))(Data_Functor.map(Data_Maybe.functorMaybe)((function () {
                                      var $17 = Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt);
                                      var $18 = Data_Array.mapWithIndex(function (i) {
                                          return function (x) {
                  ...
                  var makeRow = function (i) {
                      return function (xs) {
                          return Halogen_HTML_Elements.tr([ LogicWeb_Components_Common.css("font-sans h-10") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)((function () {
                              var $20 = Halogen_HTML_Elements.td([ LogicWeb_Components_Common.css("border-t px-3 border-yukiRed") ]);
                              return function ($21) {
                                  return $20(Data_Array.singleton(Halogen_HTML_Core.text(showBoolean($21))));
                              };
                          })())(xs))([ Halogen_HTML_Elements.td([ LogicWeb_Components_Common.css("border-l-4 border-t border-yukiRed h-9 w-9"), Halogen_HTML_Events.onClick(function (v3) {
                  ...
                  return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("bg-yukiYellow h-full p-3 flex flex-row") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("flex flex-col") ])([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("flex flex-col rounded-md bg-white shadow-md items-start") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("h-12 w-auto m-3") ])([ LogicWeb_Components_HTML_RootButton.button([ Halogen_HTML_Core.text("\u5909\u6570\u8ffd\u52a0") ])(function (v3) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v1.value1)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(v1.value0)([ Data_Show.show(Data_Show.showInt)(Data_Array.length(v1.value0)) ])))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v2.value1)(Data_Array.concat(Data_Array.zipWith(function (x) {
                              return function (y) {
                                  return [ x, y ];
                              };
                          })(v2.value0)(v2.value0))))(function () {
                              return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Unit.unit);
                          });
                      });
                  }) ]) ])(Data_Array.mapWithIndex(function (i) {
                      return function (v3) {
                          return Halogen_HTML_Elements.input([ LogicWeb_Components_Common.css("text-lg w-80 p-3 border-b-2 mb-3 border-yukiRed outline-none"), Halogen_HTML_Properties.value(v3), Halogen_HTML_Events.onValueInput(function (s) {
                              return Halogen_Hooks_HookM.put(v1.value1)(Data_Maybe.fromMaybe(v1.value0)(Data_Array.updateAt(i)(s)(v1.value0)));
                          }) ]);
                      };
                  })(v1.value0))) ]), Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("shadow-md bg-white relative z-30 p-5 rounded-md flex flex-col items-center ml-3") ])([ Halogen_HTML_Elements.table([ LogicWeb_Components_Common.css("table-fixed text-xl border-collapse whitespace-nowrap mt-3 tracking-wider") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.tr([ LogicWeb_Components_Common.css("font-math h-10") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)((function () {
                      var $22 = Halogen_HTML_Elements.th([ LogicWeb_Components_Common.css("border-b-4 px-3 border-yukiRed") ]);
                      return function ($23) {
                          return $22(Data_Array.singleton(Halogen_HTML_Core.text($23)));
                      };
                  })())(v1.value0))([ Halogen_HTML_Elements.th([ LogicWeb_Components_Common.css("border-l-4 border-b-4 px-3 border-yukiRed") ])([  ]) ])) ])(Data_Array.mapWithIndex(makeRow)(Data_Unfoldable.replicateA(Control_Applicative.applicativeArray)(Data_Unfoldable.unfoldableArray)(Data_Traversable.traversableArray)(Data_Array.length(v1.value0))([ false, true ])))) ]) ])(Data_Maybe.fromMaybe([ Halogen_HTML_Core.text("\u5909\u6570\u540d\u304c\u91cd\u8907\u3057\u3066\u3044\u307e\u3059") ])(Data_Functor.map(Data_Maybe.functorMaybe)(function ($24) {
                      return Data_Array.singleton(LogicWeb_Components_HTML_TruthTable.displayTruthTable($24));
                  })(makeTruthTable)))));
              });
          });
      };
          ...
          return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(LogicWeb_Type_Page.FormulaEditor.value))(function (v2) {
              var makeMenu = function (iconFont) {
                  return function (p) {
                      return Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("cursor-pointer text-3xl w-14 h-16 flex items-center justify-center " + (function () {
                          var $6 = Data_Eq.eq(LogicWeb_Type_Page.eqPage)(p)(v2.value0);
                          if ($6) {
                              return "";
                          };
                          return "opacity-50";
              ...
              return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("h-auto flex flex-row text-yukiBlack") ])([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("min-h-screen w-16 bg-yukiBlack text-white flex flex-col items-center") ])([ makeMenu("fas fa-align-left")(LogicWeb_Type_Page.FormulaEditor.value), makeMenu("fas fa-table")(LogicWeb_Type_Page.TruthTableEditor.value) ]), Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("min-h-screen flex-grow") ])([ (function () {
                  if (v2.value0 instanceof LogicWeb_Type_Page.FormulaEditor) {
                      ...
                      })(Data_Ord.ordUnit)(formulaEditor_)(Data_Unit.unit)(LogicWeb_Components_Pages_FormulaEditor.component)(Data_Unit.unit);
                  };
                  if (v2.value0 instanceof LogicWeb_Type_Page.TruthTableEditor) {
                      ...
                      })(Data_Ord.ordUnit)(truthTableEditor_)(Data_Unit.unit)(LogicWeb_Components_Pages_TruthTableEditor.component)({
                          variables: [ "\u03b1" ],
                          output: "output",
                          table: function (f) {
                              var v3 = f("0");
                  ...
                  throw new Error("Failed pattern match at LogicWeb.Components.Body (line 41, column 9 - line 49, column 14): " + [ v2.value0.constructor.name ]);
              })() ]) ]));
          });
      };
  });
...
(function($PS) {
  ...
  var main = Effect_Aff.launchAff_(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("body"))(function (bodyElem) {
          return Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_Foldable.foldableMaybe)(Halogen_VDom_Driver.runUI(LogicWeb_Components_Body.component)(Data_Unit.unit))(bodyElem);
      });
  }));
  exports["main"] = main;
})(PS);
