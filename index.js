...
(function($PS) {
  ...
  var splitCaseEmpty = function (p) {
      return function (v) {
          ...
          return Data_String_Common.split(p)(v);
      };
  };
      ...
      return function (dictMonadStore) {
          return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Effect_Class.liftEffect(dictMonadEffect)(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.localStorage)(Web_HTML.window)))(function (s) {
              return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Data_Functor.map((((dictMonadEffect.Monad0()).Bind1()).Apply0()).Functor0())(function (v) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)((dictMonadEffect.Monad0()).Bind1())(Effect_Class.liftEffect(dictMonadEffect)(Web_Storage_Storage.setItem("formulas")(Data_String_Common.joinWith(";")(formulas))(s)))(function () {
                      return Control_Bind.bind((dictMonadEffect.Monad0()).Bind1())(Data_Functor.map((((dictMonadEffect.Monad0()).Bind1()).Apply0()).Functor0())(function (v) {
                          return v.truthTables;
                      })(Halogen_Store_Monad.getStore(dictMonadStore)))(function (truthTables) {
                          return Effect_Class.liftEffect(dictMonadEffect)(Web_Storage_Storage.setItem("truthTables")(Data_String_Common.joinWith(";")(Data_Functor.map(Data_Functor.functorArray)(LogicWeb_Type_RawTruthTable.toString)(truthTables)))(s));
                      });
                  });
              });
          });
