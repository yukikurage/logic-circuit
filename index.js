          ...
          return Halogen_Hooks_Component.component(function (v) {
              return function (v1) {
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(LogicWeb_Type_Page.FormulaEditor.value))(function (v2) {
                      ...
                      return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("h-auto flex flex-row text-yukiBlack") ])([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("min-h-screen w-16 bg-yukiBlack text-white flex flex-col items-center relative") ])([ makeMenu("fas fa-align-left")(LogicWeb_Type_Page.FormulaEditor.value), makeMenu("fas fa-table")(LogicWeb_Type_Page.TruthTableEditor.value), Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("font-math absolute bottom-11 transform -rotate-90 text-lg cursor-pointer") ])([ Halogen_HTML_Core.text("Yukiworks"), Halogen_HTML_Elements.a([ LogicWeb_Components_Common.css("absolute bottom-0 top-0 right-0 left-0"), Halogen_HTML_Properties.href(" https://yukikurage.github.io/portfolio/") ])([  ]) ]) ]), Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("min-h-screen flex-grow bg-yukiYellow") ])([ (function () {
                          ...
                          throw new Error("Failed pattern match at LogicWeb.Components.Body (line 48, column 9 - line 50, column 94): " + [ v2.value0.constructor.name ]);
                      })() ]) ]));
                  });
              };
          });
