                  ...
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(""))(function (v2) {
                      return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.put(v1.value1)(v.messageHandler(v2.value0)))(function () {
                          ...
                          return Halogen_Hooks_Hook.discard(Halogen_Hooks.useQuery(token.queryToken)(function (v3) {
                              ...
                              throw new Error("Failed pattern match at LogicWeb.Components.Input (line 34, column 35 - line 39, column 22): " + [ v3.constructor.name ]);
                          }))(function () {
                              ...
                              })()) ])([ Halogen_HTML_Core.text(v.name) ]), Halogen_HTML_Elements.input([ LogicWeb_Components_Common.css("font-math text-3xl flex-grow p-4 tracking-widest outline-none w-full"), Halogen_HTML_Properties.readOnly(v.isReadOnly), Halogen_HTML_Properties.value(v2.value0), Halogen_HTML_Events.onValueInput(function (s) {
                  ...
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(Data_Maybe.Nothing.value))(function (v3) {
                      ...
                      var getValues = function (xs) {
                          return Data_Functor.map(Halogen_Hooks_HookM.functorHookM)((function () {
                              var $31 = Data_Maybe.fromMaybe([  ]);
                              var $32 = Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe);
                              return function ($33) {
                                  return $31($32($33));
                              };
  ...
  var component = function (dictMonad) {
      return function (dictMonadStore) {
          return Halogen_Hooks_Component.component(function (token) {
              return function (v) {
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(LogicWeb_PropositionalLogic_TruthTable.emptyTruthTable))(function (v1) {
                      var operators = Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(function (x) {
                          return x.symbol + "P";
                      })(LogicWeb_PropositionalLogic_Formula_Primitive.primEnv.monadicOperators))(Data_Functor.map(Data_Functor.functorArray)(function (x) {
                          return "P" + (x.symbol + "Q");
                      })(LogicWeb_PropositionalLogic_Formula_Primitive.primEnv.binaryOperators));
                      var messageHandler = function (v2) {
                          return "";
                      };
                      var handleInputsOutput = function (v2) {
                          return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.request()({
                              reflectSymbol: function () {
                                  return "inputsList_";
                              }
                      ...
                      })(Data_Ord.ordUnit)(token.slotToken)(inputsList_)(Data_Unit.unit)(LogicWeb_Components_InputsList.SetValues.create(operators)))(function () {
                          return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Maybe.Nothing.value);
                      })))(function () {
                          return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("flex flex-row h-full relative animate-fade-in-quick") ])([ Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("duration-75 flex-grow h-full bg-white shadow-md relative") ])([ Halogen_HTML.slot()({
                              reflectSymbol: function () {
                              ...
                              messageHandler: messageHandler,
                              isReadOnly: true
                          })(handleInputsOutput) ]), Halogen_HTML_Elements.div([ LogicWeb_Components_Common.css("overflow-auto w-auto font-meiryo text-lg flex-col flex items-center p-3") ])([ LogicWeb_Components_HTML_TruthTable.displayTruthTable(dictMonad)(dictMonadStore)(v1.value0) ]) ]));
                      });
                  });
              };
          });
